...
const BuySection = () => {
  return (
    <section id="comprar" className="py-20 md:py-32 gradient-sage relative overflow-hidden" aria-labelledby="buy-heading">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <figure className="flex justify-center">
            <div className="relative">
              <div className="absolute -inset-8 bg-white/10 rounded-3xl blur-2xl" aria-hidden="true" />
              <img
                src={bookCover}
                alt="Portada del libro Guía de Nueva York disponible para comprar"
          ...
          <div className="text-center lg:text-left">
            <h2 id="buy-heading" className="font-display text-4xl md:text-5xl text-primary-foreground mb-4">
                ...
                return (
                  <li key={index}>
                    <a
                      ...
                      aria-label={`Comprar en ${option.title} - ${option.type}`}
                    >
                      ...
                      <ExternalLink className="w-5 h-5 text-primary-foreground/50 group-hover:text-primary-foreground transition-colors" aria-hidden="true" />
                    </a>
                  </li>
                );
              })}
