...
const HeroSection = () => {
  ...
  return (
    <header className="relative flex items-center justify-center overflow-hidden gradient-sage">
      ...
      <div className="container relative z-10 py-16 md:py-20 lg:py-24 pt-20 md:pt-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Book Cover */}
          <figure className="flex justify-center lg:justify-end order-1 lg:order-2 animate-fade-up">
            <div className="relative">
              <div className="absolute -inset-4 gradient-sage opacity-30 blur-3xl rounded-3xl" aria-hidden="true" />
              <img
                src={bookCover}
                alt="Portada del libro Guía de Nueva York por Rafa Vega y Carlos Sánchez - Una guía con fotografías de la Gran Manzana"
          ...
          <div className="text-center lg:text-left order-2 lg:order-1 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-4 animate-fade-up delay-400">
              <a
                ...
                aria-label="Comprar Guía de Nueva York en Amazon"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Comprar Guía de Nueva York en Gigantes del Basket"
              >
                <Button variant="hero" size="lg">
                  <ShoppingCart className="w-5 h-5 mr-2" aria-hidden="true" />
                  Ver en Gigantes
